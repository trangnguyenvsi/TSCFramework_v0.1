...
public class TestData {
	...
	public static Object[][] getLoginData() {
		Object[][] data = Utility.getTable("./data/TestData.xlsx", "Login", "LO02");
		return data;
	}

	@DataProvider(name = "dpValidateCustomer")
	public static Object[][] getValidateCustomerData() {
		Object[][] data = Utility.getTable("./data/TestData.xlsx", "CreateNewCustomer", "CN02");
		return data;
	}
	
	@DataProvider(name="dpNewCustomer")
	public static Object[][]  getCustomerData() {
		Object[][] data = Utility.getTable("./data/TestData.xlsx", "CreateNewCustomer", "CN03");
		return data;
	}
